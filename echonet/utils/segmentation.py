    ...
    with open(os.path.join(output, "log.csv"), "a") as f:
        ...
        for epoch in range(epoch_resume, num_epochs):
            ...
            for phase in ['train', 'val']:
                ...
                writer.add_scalar("OverallDice/" + phase, overall_dice, epoch)
                writer.add_scalar("LargeDice/" + phase, large_dice, epoch)
                writer.add_scalar("SmallDice/" + phase, small_dice, epoch)
            scheduler.step()
